...
export async function runTranslate({
    ...
    // .env is now one folder up from main.mjs
    ...
    try {
        ...
        processDep.stderr.write(`[translate] .env file not found: ${dotenvPath}\n`);
    ...
    try {
        ...
        processDep.stderr.write(`[translate] en-US.json not found: ${enUSPath}\n`);
        processDep.stderr.write(`[translate] Error: ${e && e.message ? e.message : e}\n`);
        return 1;
    }
